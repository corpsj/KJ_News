...
-- RLS Policies
CREATE POLICY "Anon insert contact messages" ON contact_messages FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Authenticated read contact messages" ON contact_messages FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated update contact messages" ON contact_messages FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Authenticated delete contact messages" ON contact_messages FOR DELETE TO authenticated USING (true);
