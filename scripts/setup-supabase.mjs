...
async function seedData() {
  ...
  // Authors
  const authors = [
    { id: 1, name: "김서현", role: "정치부 기자", avatar_url: "https://picsum.photos/seed/author1/100/100" },
    { id: 2, name: "박준영", role: "경제부 기자", avatar_url: "https://picsum.photos/seed/author2/100/100" },
    { id: 3, name: "이지은", role: "사회부 기자", avatar_url: "https://picsum.photos/seed/author3/100/100" },
    { id: 4, name: "최민호", role: "국제부 기자", avatar_url: "https://picsum.photos/seed/author4/100/100" },
    { id: 5, name: "정하늘", role: "IT/과학부 기자", avatar_url: "https://picsum.photos/seed/author5/100/100" },
  ];
