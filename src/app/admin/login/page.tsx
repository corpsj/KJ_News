    ...
    <div className="w-full max-w-[400px] animate-fade-in">
      ...
      <div className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(0,0,0,0.06)] border border-gray-100 p-8 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {error && (
            <div className="flex items-center gap-2.5 px-3.5 py-3 bg-gray-50 rounded-lg border border-gray-200" role="alert" id="login-error">
          ...
          >
            {isLoading ? (
              <span className="flex items-center gap-2" aria-label="로그인 중">
