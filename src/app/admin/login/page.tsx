    ...
    <div className="admin-card w-full max-w-sm p-8 animate-fade-in">
      ...
      {toastMessage && (
        <div className="fixed bottom-5 right-5 z-[100] flex items-center gap-2 px-4 py-2.5 rounded-lg text-[13px] font-medium shadow-sm border bg-white text-gray-900 border-gray-200">
          <svg className="w-4 h-4 text-gray-900 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>Error</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
          {toastMessage}
        </div>
      )}
    </div>
