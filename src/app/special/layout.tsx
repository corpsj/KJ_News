    ...
    <>
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center h-16 md:h-20 gap-4">
            ...
            <span className="text-xs font-bold text-gray-900 bg-gray-100 px-3 py-1 rounded tracking-wide">
              창간특별호
            </span>
          </div>
        </div>
